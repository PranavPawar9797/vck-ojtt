...
import "../styles/Pages.css"; // Keep this for page content styling
          ...
          <section className="page-section">
            <div className="page-content-wrapper">
              ...
              <p className="section-text">
                ...
                Our state-of-the-art facilities, experienced faculty, and diverse student community create a unique ecosystem
          ...
          <section className="page-section">
            <div className="page-content-wrapper">
              ...
              <ul className="section-list">
                ...
                <li><strong>Experienced Faculty:</strong> Renowned experts in their fields.</li>
                <li><strong>Modern Facilities:</strong> Fully equipped labs, library, and campus.</li>
                <li><strong>Holistic Development:</strong> Co-curricular activities and sports.</li>
                <li><strong>Strong Placements:</strong> Opportunities in top companies.</li>
              </ul>
            </div>
          </section>
          ...
          <section className="page-section">
            <div className="page-content-wrapper">
              ...
              <p className="section-text mt-4">
                Explore our vibrant campus and state-of-the-art facilities that support your academic and personal growth.
              </p>
            </div>
          </section>
