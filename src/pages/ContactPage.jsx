...
const ContactPage = () => {
  return (
    <> {/* Use a React Fragment here */}
      ...
      <div className="page-container contact-page"> {/* The rest of your page content remains within page-container */}
        <main className="page-content-wrapper">
          ...
          <section className="page-section">
            ...
            {/* Moved "Send Us a Message" outside map-container if it's a separate section */}
            <section className="page-section">
