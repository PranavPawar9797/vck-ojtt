...
const AboutPage = () => {
    return(
      ...
      <p>
      Vivekanand College stands as a beacon of knowledge and integrity, committed to delivering transformative education since its inception in <strong>[Year of Establishment, e.g., 1980]</strong>. Located in the bustling heart of <strong>[City/Area, e.g., Chembur, Mumbai]</strong>, our college has consistently strived to uphold the highest standards of academic rigor and ethical values.
    </p>
    <p>
